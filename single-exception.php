				...
				<div class="text-block">
					...
					<div class="box">
						<p>Ежегодно Правительство Москвы формирует Перечень объектов налогообложения, собственники которых платят налог на имущество исходя из кадастровой стоимости. Собственники таких объектов вправе как снижать установленную кадастровую стоимость, так
							и оспаривать законность и обоснованность включения их здания (помещения) в Перечень.</p>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="text-block">
					...
					<div class="box">
						<ul>
							...
							<li>
								<a href="https://www.mos.ru/upload/documents/docs/1574-PP.pdf" target="_blank">Постановление Правительства Москвы № 1574-ПП от 26.11.2019 (на 2020 год)</a>
							</li>
							<br/>
						</ul>
					</div>
