				...
				<div class="section-wrap">
					...
					<div class="section-call">
						...
						<div class="box">
							...
							<p class="attanintion">
								<b>ВАЖНО:</b> В связи с продлением дачной амнистии до 01.03.2018 г. получение разрешения на ввод постройки ИЖС и ЛПХ в эксплуатацию не требуется. Также не требуется получения разрешения на строительство домов, расположенные на землях под дачное
