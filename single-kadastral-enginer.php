...
<div class="section section-step">
	<div class="main-cont">
		<div class="section-title">В каких случаях нужны услуги кадастрового инженера?</div>
		<div class="solution">
			<div class="solution__el">
				...
				<div class="solution__el-title">При установлении границ (межевании) земельного участка, формировании земельного
					участка, разделе земельного участка, объединении нескольких смежных земельных участков
				</div>
				<div class="solution__el-text">Любые действия, связанные с внесением и/или изменением в ЕГРН каких-либо сведений
					о земельном участке (земельных участках), требующие подготовку межевого плана.
				</div>
			</div>
			<div class="solution__el">
				<div class="solution__el-icon">
			...
			<div class="solution__el">
				...
				<div class="solution__el-title">При исправлении реестровой (кадастровой) ошибки об объекте недвижимости в
					сведениях ЕГРН
				</div>
				<div class="solution__el-text">Для исправления реестровой ошибки кадастровым инженером формируется новый межевой
					или технический план, на основании которого Росреестр вносит в ЕГРН корректные сведения в отношении объекта
...
<!--from begin-->
<div class="section section--start section--lg" id="price"
