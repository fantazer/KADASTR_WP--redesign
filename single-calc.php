	      ...
	      <? the_content();?>
				<div class="calculator">
						...
						<div class="calculator-msg" data-msg="techplanKv">
							<sup>*</sup> Стоимость зависит от площади квартиры и необходимости производства обмеров.</div>
						<!--Перепланировка помещения-->
						<div class="calculator-msg" data-msg="pereplan">
							<sup>*</sup> Стоимость зависит от площади помещения и необходимости производства обмеров.</div>
						<!--Кадастровая съемка-->
						<div class="calculator-msg" data-msg="kadSemka">
							<sup>*</sup> Стоимость зависит от площади и местоположения участка.</div>
						<!--Вынос границ земельного участка-->
						<div class="calculator-msg" data-msg="vinosGran">
							<sup>*</sup> Стоимость минимального выезда 8000 руб.</div>
					</div>
			</div>
		</div>
	</div>
